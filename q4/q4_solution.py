...
def main():
    ...
    for t in range(0, 1000, 100):
        ...
        results_df = results_df.append({'time': t, 'total_qos': total_qos, 'URLLC_avg_qos': urllc_avg_qos, 'eMBB_avg_qos': embb_avg_qos, 'mMTC_avg_qos': mmtc_avg_qos}, ignore_index=True)
        results_df.to_csv('/Users/a/Documents/Projects/web_question/q4/results.csv', index=False)
